...
export async function GET() {
  ...
  try {
    const { data, error } = await supabase
      .from('howto_guides')
      .select('id, title, slug, description, category, google_doc_url, prompt_content, preview_image_url, price, energy, related_ids, status, tiktok_url, display_order, featured, created_at, stripe_product_id, stripe_price_id')
