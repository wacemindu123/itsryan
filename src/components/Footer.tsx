    ...
    <footer className="py-20 text-center bg-[var(--surface)] border-t border-black/5">
      <div className="max-w-[980px] mx-auto px-[22px]">
        <div className="flex justify-center gap-8 mb-6">
          <Link href="mailto:widgeon1996@gmail.com" onClick={() => analytics.externalLinkClick('mailto:widgeon1996@gmail.com', 'email')} className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:scale-110 transition-all">
