  ...
  return (
    ...
    >
      <div className="max-w-[980px] mx-auto px-[22px]">
        ...
        <div className="grid grid-cols-2 gap-8 mt-[60px] max-md:grid-cols-1">
          <div className="bg-[var(--background)] p-14 px-12 rounded-[18px] hover:scale-[1.02] transition-all">
            <span className="inline-block bg-[var(--accent)] text-white px-3 py-1 rounded-xl text-sm font-medium mb-6">
              Option 1
            </span>
            <h3 className="text-[32px] mb-4 text-[var(--text-primary)] font-semibold tracking-[-0.5px]">I Build It</h3>
            <p className="text-[var(--text-secondary)] mb-8 text-[19px] leading-[1.5]">
            ...
            <ul className="list-none mb-8">
              {['Tools worth $50k+', 'Custom for your business', 'You own everything', 'Actually free'].map((item, i) => (
                <li key={i} className="py-3 text-[var(--text-primary)] text-[17px] relative pl-7">
          ...
          <div className="bg-[var(--background)] p-14 px-12 rounded-[18px] hover:scale-[1.02] transition-all">
            ...
            <h3 className="text-[32px] mb-4 text-[var(--text-primary)] font-semibold tracking-[-0.5px]">Learn AI</h3>
            <p className="text-[var(--text-secondary)] mb-8 text-[19px] leading-[1.5]">
